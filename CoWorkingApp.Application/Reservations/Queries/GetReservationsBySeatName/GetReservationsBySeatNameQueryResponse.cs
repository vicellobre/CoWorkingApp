...
public readonly record struct GetReservationsBySeatNameQueryResponse(
    Guid ReservationId,
    DateTime Date,
...
{
    /// <summary>
    /// Convierte explícitamente un objeto <see cref="Reservation"/> a <see cref="GetReservationsBySeatNameQueryResponse"/>.
    /// </summary>
    /// <param name="reservation">La reserva a convertir.</param>
    public static explicit operator GetReservationsBySeatNameQueryResponse(Reservation reservation) =>
        new(
            reservation.Id,
            reservation.Date,
