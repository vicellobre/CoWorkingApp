...
public readonly record struct GetReservationsBySeatIdQueryResponse(
    Guid ReservationId,
    DateTime Date,
...
{
    /// <summary>
    /// Convierte una instancia de <see cref="Reservation"/> en <see cref="GetReservationsBySeatIdQueryResponse"/>.
    /// </summary>
    /// <param name="reservation">La reserva a convertir.</param>
    public static explicit operator GetReservationsBySeatIdQueryResponse(Reservation reservation) =>
        new(
            reservation.Id,
            reservation.Date,
