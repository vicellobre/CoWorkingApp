...
{
    /// <summary>
    /// Convierte explícitamente un objeto <see cref="Reservation"/> a <see cref="UpdateReservationCommandResponse"/>.
    /// </summary>
    /// <param name="reservation">La reserva a convertir.</param>
    public static explicit operator UpdateReservationCommandResponse(Reservation reservation) =>
        new(
            reservation.Id,
            reservation.Date,
