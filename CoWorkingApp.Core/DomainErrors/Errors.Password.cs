...
public static partial class Errors
{
    ...
    public static class Password
    {
        ...
        /// </summary>
        public static readonly Error IsNullOrEmpty = Error.Create("Password.IsNullOrEmpty", "The password cannot be empty.");

        /// <summary>
        /// Indica que el password debe de seguir el formato establecido.
        /// </summary>
        public static readonly Error InvalidFormat = Error.Create("Password.InvalidFormat", "The password does not meet the formatting guidelines.");
        ...
        public static readonly Func<int, Error> TooLong = length => Error.Create("Password.TooLong", $"The password cannot exceed {length} characters.");
        ...
        public static readonly Func<int, Error> TooShort = length => Error.Create("Password.TooShort", $"The password must be at least {length} characters.");
    }
}
