...
public static partial class Errors
{
    ...
    public static class LastName
    {
        ...
        /// </summary>
        public static readonly Error IsNullOrEmpty = Error.Validation("LastName.IsNullOrEmpty", "The last name cannot be empty.");

        /// <summary>
        /// Indica que el formato del apellido es inválido.
        /// </summary>
        public static readonly Error InvalidFormat = Error.Validation("LastName.InvalidFormat", "The last name format is invalid.");
        ...
        public static readonly Func<int, Error> TooLong = length => Error.Validation("LastName.TooLong", $"The last name cannot exceed {length} characters.");
        ...
        public static readonly Func<int, Error> TooShort = length => Error.Validation("LastName.TooShort", $"The last name must be at least {length} characters.");
    }
}
