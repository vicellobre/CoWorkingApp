...
public static partial class Errors
{
    ...
    public static class FirstName
    {
        ...
        /// </summary>
        public static readonly Error IsNullOrEmpty = Error.Validation("FirstName.IsNullOrEmpty", "The first name cannot be empty.");

        /// <summary>
        /// Indica que el formato del primer nombre es inválido.
        /// </summary>
        public static readonly Error InvalidFormat = Error.Validation("FirstName.InvalidFormat", "First name format is invalid.");
        ...
        public static readonly Func<int, Error> TooLong = length => Error.Validation("FirstName.TooLong", $"First name cannot be longer than {length} characters.");
        ...
        public static readonly Func<int, Error> TooShort = length => Error.Validation("FirstName.TooShort", $"First name must be at least {length} characters.");
    }
}
