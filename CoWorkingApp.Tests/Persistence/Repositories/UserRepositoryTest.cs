...
//                // Configura el mock para lanzar la InvalidOperationException cuando se llame a Set<User>()
//                mockContext.Setup(u => u.Set<User>())
...
//                // Configura el mock para que Set<User>() devuelva un DbSet válido (simula que la base de datos está correctamente configurada)
//                var mockContext = new Mock<CoWorkingContext>(new DbContextOptions<CoWorkingContext>());
